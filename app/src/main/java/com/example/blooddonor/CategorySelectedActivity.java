...
public class CategorySelectedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //pass users who are compatible with logged in user/current user
        if (getIntent().getExtras() != null){
            ...
            if (title.equals("Compatible with me")){
                getCompatibleUsers();
                getSupportActionBar().setTitle("Compatible with me"+ title);
            }else {
                readUsers();
            }
    ...
    private void readUsers() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //using the search field from our firebase to filter accurately
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("users");
